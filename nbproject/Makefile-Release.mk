...
${TESTDIR}/tests/FixparserUnitTest.o: tests/FixparserUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/FixparserUnitTest.o tests/FixparserUnitTest.cpp


${TESTDIR}/tests/FixparserUnitTestRunner.o: tests/FixparserUnitTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/FixparserUnitTestRunner.o tests/FixparserUnitTestRunner.cpp
