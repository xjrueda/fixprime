...
${OBJECTDIR}/src/FixParser.o: src/FixParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FixParser.o src/FixParser.cpp
...
${OBJECTDIR}/src/Thorium.o: src/Thorium.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Thorium.o src/Thorium.cpp
...
${TESTDIR}/tests/ProtocolUnitTest.o: tests/ProtocolUnitTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -Iinclude -I. -Iinclude -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProtocolUnitTest.o tests/ProtocolUnitTest.cpp


${TESTDIR}/tests/ProtocolUnitTestRunner.o: tests/ProtocolUnitTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -Iinclude -I. -Iinclude -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProtocolUnitTestRunner.o tests/ProtocolUnitTestRunner.cpp
...
${OBJECTDIR}/src/FixParser_nomain.o: ${OBJECTDIR}/src/FixParser.o src/FixParser.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/local/include -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FixParser_nomain.o src/FixParser.cpp;\
	else  \
...
${OBJECTDIR}/src/Thorium_nomain.o: ${OBJECTDIR}/src/Thorium.o src/Thorium.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/local/include -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Thorium_nomain.o src/Thorium.cpp;\
	else  \
